...
**Improvement since v1.8.0 ([HTPR-5776]):** In earlier versions, `htz capabilities` printed a larger 55 KB JSON document regardless of argument usage. Now, human-facing usage prints a compact Markdown summary. Agents that request `--json` receive the full machine-readable catalog.
