...
<Aside type="tip">
Before v1.3.4, an unrecognised subcommand exited with code `0` and printed the root help page, making it invisible to shell scripts checking `$?`. Since v1.3.4 these exits use code `2` (the POSIX convention for command-line usage errors) and print a clear error message. Update to ≥ 1.3.4 if your scripts rely on exit codes.
</Aside>
