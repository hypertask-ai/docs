...
<Aside type="tip">
If you prefer to skip renewal and see the exact expiry value, rerun `htz login` without overriding credentials—it will replay the saved cookie or JWT and decide to refresh vs rotate.
</Aside>
