...
<Aside type="tip">
<code>task show</code> is an alias for <code>task get</code> — both commands are identical. The full task description is always included in the output, making <code>task get</code> the right tool to inspect a task's complete content.
</Aside>
