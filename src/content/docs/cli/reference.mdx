...
```
  ╔═══════════════════════════════════════════╗
  ║  Update available: 1.3.3 → 1.3.4         ║
  ║  Run: npm install -g @hypertask/hypertask_cli  ║
  ╚═══════════════════════════════════════════╝
```
...
Search for tasks by keyword. Results display full ticket titles (wrapping long titles across multiple lines in the table so nothing is cut off), links to each task, and only the columns that have data — empty columns are omitted automatically.
