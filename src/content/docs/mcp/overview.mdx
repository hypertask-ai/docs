...
<Aside type="tip">
For features not yet available via MCP, use the <a href="/cli/reference/">Hypertask CLI</a> as a workaround â it supports labels, due dates, and description updates.
</Aside>
