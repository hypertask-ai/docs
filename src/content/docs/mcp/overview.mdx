...
Turn the flag on at <a href="https://app.hypertask.ai/admin/flags">https://app.hypertask.ai/admin/flags</a> with key <code>htpr-6531-deferred-mcp-tools</code>. Other accounts still receive the full catalog on connect.
