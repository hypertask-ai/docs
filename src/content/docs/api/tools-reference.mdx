...
<Aside type="caution">
`due_date` and `labels` are **not yet supported** on task creation via MCP. Use the <a href="/cli/reference/">CLI</a> or the Hypertask UI to set these fields.
</Aside>
...
<Aside type="caution">
`due_date` and `labels` are **not yet supported** on task updates via MCP. Use the <a href="/cli/reference/">CLI</a> or the Hypertask UI to set these fields.
</Aside>
