...
2. **First board generation.** New free-tier accounts start with an empty board. A default section is seeded, and the AI chat is open by default on desktop; your manual chat state persists until you close the chat manually. No static fallback board appears by default. ([HTPR-4866](https://app.hypertask.ai/detail/project-15/4866))
