...
1. **Sign up** at [hypertask.ai](https://hypertask.ai) using email or Google. Bypass the onboarding routine on signup routes to land directly on your board ([HTPR-5639](https://app.hypertask.ai/detail/project-15/5639)).
...
4. **Set up sections.** Every new project starts with default sections. A typical workflow uses:
   ...
   | Section | Purpose |
   |---------|---------|
   | Todo | Work thatâ\x80\x99s ready to be picked up |
