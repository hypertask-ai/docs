...
<Update label="August 31, 2026">
  * Improved: POST /mcp/tasks/move now preserves identity for same-board moves; cross-board moves retain existing renumbering ([HTPR-5740](https://app.hypertask.ai/detail/project-15/5740))
