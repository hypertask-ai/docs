...
<Update label="September 1, 2026">
  ...
  * Fixed: Comment drafts stay with the ticket where typed rather than bleeding across other tickets ([HTPR-5868](https://app.hypertask.ai/detail/project-15/5868))
