...
<Update label="September 1, 2026">
  ...
  * Fixed: Worker broker access now maintains broker URL and handle through mid-turn boundaries, preventing push failures ([HTPR-5878](https://app.hypertask.ai/detail/project-15/5878))
</Update>
