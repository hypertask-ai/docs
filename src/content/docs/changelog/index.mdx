...
<Update label="August 25, 2026">
  <p>Ã°ï¿½Â¯ The following tickets this run failed the shipped gate and were deferred:</p>
  <ul>
    <li><a href="https://app.hypertask.ai/detail/project-15/5663">HTPR-5663</a> Ã¢ï¿½ï¿½ Task move from board modal is failing on board name clicks</li>
    <li><a href="https://app.hypertask.ai/detail/project-15/5674">HTPR-5674</a> Ã¢ï¿½ï¿½ CLI/MCP agent auto-assign fails when trying to hand off tasks</li>
    <li><a href="https://app.hypertask.ai/detail/project-15/5683">HTPR-5683</a> Ã¢ï¿½ï¿½ Archived task reminders trigger and disappear without alerting the user</li>
  </ul>
</Update>