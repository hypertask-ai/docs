...
Hypertask is built for teams â\x80\x94 whether that\'s two founders, a 50-person engineering org, or a mix of humans and AI agents. Every feature is designed around the idea that project management is inherently collaborative.
...
This way, conversations that started in Slack don\'t die there â\x80\x94 they live permanently on the right ticket for your team and agents.

### Requirements and setup

- **Slack app permissions:** Ensure your Slack app has:
  - `chat:write` â\x80\x94 to reply with ticket links
  - `chat:write.public` â\x80\x94 to post in channels you don\'t own
...
- **Approve** â\x80\x94 Applies the agent\'s suggested action with one tap
