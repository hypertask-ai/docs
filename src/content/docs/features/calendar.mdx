...
Turn off **Keep tasks updated** to remove Hypertask-managed events without touching personal events. Select **Disconnect** to remove managed events and revoke Hypertask's Google access. If you added personal events to the Hypertask calendar, those events and the calendar remain in your Google account.
