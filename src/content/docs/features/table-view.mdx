...
**Horizontal scrollbar on narrow windows:** When the table columns exceed the available width (e.g., on half-screen viewports), a thin horizontal scrollbar appears at the bottom edge of the table. The vertical scrollbar stays hidden. This lets you scroll columns laterally without obscuring the rest of the interface.
