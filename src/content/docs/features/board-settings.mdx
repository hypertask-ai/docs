...
<Aside type="tip">
Use per-column auto-assign for specialized workflows—for example, “On-call” rotations, triage columns that should always go to the reviewer on duty, or QA columns where incoming issues are handled by dedicated testers.</Aside>
