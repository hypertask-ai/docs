...
description: "Manage board notifications, auto-archive, staleness detection, time tracking, and per-column auto-assign rules."
---

import { Aside, Card, CardGrid, Steps } from '@astrojs/starlight/components';

Use the board settings panel to control notifications and automatic behaviors for one board. You can mute a noisy board without changing your global notification preferences, then configure archival, staleness, time tracking, and assignment rules.
