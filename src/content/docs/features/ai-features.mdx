...
| Paid, legacy, and comped teams | Dedicated routed keys by entitlement | Eligible users | Server-gated; consistent with paid product tiers |
| Free and BYOK subscribers | Shared Free/BYOK included-allowance key | Luna Standard | Limited models; Premium models require server-gated entitlement |
...
- **Eligible teams** (paid, legacy, comped) default to **Luna Standard**, bypassing premium model selection during task creation.
- **Free and keyless BYOK teams** default to **Luna Standard** instead of premium Luna, preventing silent failures when selecting models.

This repair ensures consistent default model access aligned with plan capabilities.
