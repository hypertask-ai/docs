...
### House style AI text reinforcement (HTPR-5587)
...
## AI agents and style enforcement (HTPR-5648)
...
### Unified team entitlement checking for boardless AI chat (HTPR-5590)
...
## Help-site AI chat
The **help.hypertask.ai chat** provides on-the-fly documentation answers and deployment guidance. This chat is automatically enriched with Hypertask's MCP server knowledge, including tool descriptions, schemas, and workflows.
