...
| Team type | Credentials | Notes |
|-----------|-------------|-------|
| Internal team members and custom-deal teams | Dedicated managed-key registry (14 teams, 11 credentials) | Isolated from customer BYOK; production-ready and verified |
| Paid, legacy, and comped teams | Dedicated routed keys by entitlement | Server-gated; consistent with paid product tiers |
| Free and BYOK subscribers | Shared Free/BYOK included-allowance key | Includes usage within allowance tier; premium models remain server-gated |
