...
AI responses in chat and custom instructions now follow shared house-style rules to reduce "AI tells" like filler phrases and unnatural structure, and ADHD-shaping feedback applies only to chat-level refinements (not to Archive/Summarize). Speak plainly from a human-first perspective without overusing jargon, and keep the tone concise and actionable. Remove hyperbolic or contrived expressions such as "Great question!", "pivotal", "seamlessly", "robust", "leverage", "I hope this helps", and "I hope this helps!".
