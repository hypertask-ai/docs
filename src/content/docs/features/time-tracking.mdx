...
Pause and resume are currently available in the app only. The CLI and MCP surfaces can start, stop and log time, and their payloads already report whether a timer is paused, but they cannot pause one yet.
