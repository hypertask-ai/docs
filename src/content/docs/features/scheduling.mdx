...
**The split pills filter by board.** "All" shows every board's section; picking a board narrows the table to that board alone. <kbd>Tab</kbd> and <kbd>Shift+Tab</kbd> cycle through them, exactly as on the inbox and board surfaces. A red overdue count can appear next to a pill when that tab still has overdue tasks after the current filters ([HTPR-6459](https://app.hypertask.ai/detail/project-15/6459)).
