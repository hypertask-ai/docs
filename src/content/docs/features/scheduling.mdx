...
|--------|---------------|
| **Direct URL input** | Paste a trusted HTTPS URL that resolves to the provider's internal endpoint URL |
| **Provider URL completion** | Start typing a URL and let suggestions surface against an allowlist; completed URLs are validated against a public allowlist before acceptance |
