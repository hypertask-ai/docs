...
- **Set**: Press <kbd>Shift</kbd>+<kbd>B</kbd> on an open ticket, or run <kbd>Ctrl+K</kbd> â\x86\x92 "Blocked by person...", then pick the person. One blocker per ticket.
...
**Leverage it from the command palette:** <kbd>Ctrl+K</kbd> â\x86\x92 search for a task and use **Agent write-with-AI** to trigger the update.
