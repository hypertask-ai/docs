...
AI status updates appear on task cards when an AI agent updates task metadata in a visible way. This includes fields like priority, assignees, workers, labels, due dates, and related tasks. You can see these changes via the task detail panel, the board cards, and notification contexts without opening every detail.
