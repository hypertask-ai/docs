...
- **Clear**: The flag clears automatically the moment the blocked-on person comments on the ticket. Clear manually with the â\x80\x94 in the sidebar row or by picking "Nobody" in the picker.
