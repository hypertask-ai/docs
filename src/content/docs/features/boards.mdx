...
When you add a task with inline quick entry inside a label-filtered view, Hypertask applies the view's labels to the new task so it stays visible in that view.
