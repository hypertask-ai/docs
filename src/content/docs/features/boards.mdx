...
## Guest appearance on the web

When you anonymously visit a guest board from the web:

**CTA buttons in the header:** The "New task" and "Add board" CTAs in the header row and the expanded sidebar rail use the inverse theme (light color on dark background). This ensures text remains readable regardless of your system theme.
