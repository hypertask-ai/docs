...
## Undo inbox items safely ([HTPR-6527](https://app.hypertask.ai/detail/project-15/6527))
...
On narrow screens, the undo button appears on inbox rows under undoable items. Undoing an item gracefully skips empty row slots instead of crashing the list.
