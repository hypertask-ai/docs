...
<Update label="September 6, 2026">
  * Fixed: comment composer sticky behavior and dark theme frame in task detail ([HTPR-6086](https://app.hypertask.ai/detail/project-15/6086))
  * Fixed: Agent worker now enforces "finish your PR first" mechanically, not just in the prompt ([HTPR-6190](https://app.hypertask.ai/detail/project-15/6190))
</Update>

<Update label="September 5, 2026">
  * Added: Agent chat: activity rows showing started, PR-opened, review, live, QA, blocked state between messages ([HTPR-6094](https://app.hypertask.ai/detail/project-15/6094))
  * Fixed: Dedicated agent runtime installer no longer stops halfway through install; leftover cleanup for a previously-deleted file no longer triggers a delete guard ([HTPR-6172](https://app.hypertask.ai/detail/project-15/6172))
</Update>

<Update label="September 4, 2026">
  * Added: Ctrl+K "Copy current page URL" action copies the complete browser address from the command palette anywhere in the app ([HTPR-6112](https://app.hypertask.ai/detail/project-15/6112))
  * Fixed: Task shortcuts no longer navigate or submit when opened outside Inbox: Ctrl/Cmd+Enter stays on board-created tasks while Ctrl/Cmd+Shift+Enter no longer submits there ([HTPR-5901](https://app.hypertask.ai/detail/project-15/5901))
  * Fixed: Discovery pickup livelock where agents retry forever because the lease holder was reported as current_user for every agent, now resolving contention by checking conflicting lease agents ([HTPR-5873](https://app.hypertask.ai/detail/project-15/5873))
  * Fixed: Discovery pickups no longer fail with contenders losing the pickup mutation reservation, now using existing pickup lease for self-assignment ([HTPR-5879](https://app.hypertask.ai/detail/project-15/5879))
  * Improved: Mobile app no longer displays a rocket announcements button in the header, preferring Settings for updates, alerts, and unread markers ([HTPR-5856](https://app.hypertask.ai/detail/project-15/5856))
